...
///UPDATE ONE BY ID
export async function updateOneById<T>(model: ModelType<T, BeAnObject>, _id: string, data, options?: QueryOptions) {
    try {
...
export async function updateMany<T>(model: ModelType<T, BeAnObject>, query, data: object, options?: QueryOptions
) {
    try {
...
///DELETE
export async function deleteOne<T>(model: ModelType<T, BeAnObject>, query) {
    try {
...
///GET ALL /* custom */
export async function getAll<T>(model: ModelType<T, BeAnObject>, query = {}, project = {}) {
    try {
